...
class StockTradingEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            for i in i_list:
                self.reward -= self.state[i + 1] * self.state[self.stock_dim + 1 + i] * 0.01
    ...
    def initial_buy_(self):
        ...
        buy_nums_each_tic = 0.5 * self.initial_amount // (
                    avg_price * len(prices))  # only use half of the initial amount
